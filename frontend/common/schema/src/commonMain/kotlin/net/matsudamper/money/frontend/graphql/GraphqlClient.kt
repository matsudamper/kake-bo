...
import net.matsudamper.money.frontend.graphql.type.ImportedMailFilterId as ApolloImportedMailFilterId
...
object GraphqlClient {
    ...
    val apolloClient: ApolloClient = ApolloClient.Builder()
        ...
        .addCustomScalarAdapter(
            ApolloImportedMailFilterId.type,
            CustomStringAdapter(
                serialize = {
                    it.id.toString()
                },
                deserialize = { value ->
                    value.toIntOrNull()?.let { ImportedMailFilterId(it) }
                },
            ),
        )
        .addCustomScalarAdapter(
