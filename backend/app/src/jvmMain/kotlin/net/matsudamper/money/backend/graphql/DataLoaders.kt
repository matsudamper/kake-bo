...
import net.matsudamper.money.backend.dataloader.UserTimezoneDataLoaderDefine
...
internal class DataLoaders(
    ...
    val userTimezoneDataLoader by register {
        UserTimezoneDataLoaderDefine(diContainer)
    }
