...
interface MoneyUsageSubCategoryRepository {
    fun addSubCategory(userId: UserId, name: String, categoryId: MoneyUsageCategoryId): AddSubCategoryResult
    fun getSubCategory(userId: UserId, categoryId: MoneyUsageCategoryId): GetSubCategoryResult
    fun getSubCategory(userId: UserId, moneyUsageSubCategoryIds: List<MoneyUsageSubCategoryId>): GetSubCategoryResult
    fun updateSubCategory(userId: UserId, subCategoryId: MoneyUsageSubCategoryId, name: String?): Boolean
    fun deleteSubCategory(userId: UserId, subCategoryId: MoneyUsageSubCategoryId): Boolean
