...
class ImportMailUseCase(
    ...
    fun insertMail(
        ...
        return runCatching {
            val imapConfig = repositoryFactory.createUserConfigRepository().getImapConfig(userId) ?: return Result.ImapConfigNotFound
            val host = imapConfig.host ?: return Result.ImapConfigNotFound
            val port = imapConfig.port ?: return Result.ImapConfigNotFound
            val userName = imapConfig.userName ?: return Result.ImapConfigNotFound
            val password = imapConfig.password ?: return Result.ImapConfigNotFound
            ...
            mailRepository.getMails(mailIds).forEach { mail ->
                ...
                mailRepository.deleteMessage(listOf(mail.messageID))
            }
        }.fold(
            onSuccess = {
                Result.Success
