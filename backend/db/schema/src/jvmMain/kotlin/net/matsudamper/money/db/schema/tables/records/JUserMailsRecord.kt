...
open class JUserMailsRecord() : UpdatableRecordImpl<JUserMailsRecord>(JUserMails.USER_MAILS), Record6<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?> {
    ...
    override fun valuesRow(): Row6<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?> = super.valuesRow() as Row6<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?>
    ...
    override fun values(value1: Int?, value2: Int?, value3: String?, value4: String?, value5: LocalDateTime?, value6: LocalDateTime?): JUserMailsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(userMailId: Int? = null, userId: Int? = null, plain: String? = null, html: String? = null, datetime: LocalDateTime? = null, createdDatetime: LocalDateTime? = null) : this() {
