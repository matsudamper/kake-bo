...
open class JUserMailsRecord() : UpdatableRecordImpl<JUserMailsRecord>(JUserMails.USER_MAILS), Record7<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?, String?> {
    ...
    override fun valuesRow(): Row7<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?, String?> = super.valuesRow() as Row7<Int?, Int?, String?, String?, LocalDateTime?, LocalDateTime?, String?>
    ...
    override fun values(value1: Int?, value2: Int?, value3: String?, value4: String?, value5: LocalDateTime?, value6: LocalDateTime?, value7: String?): JUserMailsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(userMailId: Int? = null, userId: Int? = null, plain: String? = null, html: String? = null, datetime: LocalDateTime? = null, createdDatetime: LocalDateTime? = null, fromMail: String? = null): this() {
