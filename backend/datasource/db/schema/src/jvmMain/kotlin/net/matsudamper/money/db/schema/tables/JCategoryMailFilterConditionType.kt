...
open class JCategoryMailFilterConditionType(
     ...
     */
    override fun where(condition: Condition?): JCategoryMailFilterConditionType = JCategoryMailFilterConditionType(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): JCategoryMailFilterConditionType = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): JCategoryMailFilterConditionType = where(DSL.notExists(select))
}
