...
open class JUserPasswords(
     ...
     */
    override fun where(condition: Condition?): JUserPasswords = JUserPasswords(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): JUserPasswords = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): JUserPasswords = where(DSL.notExists(select))
}
