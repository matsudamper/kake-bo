...
open class JMoneyUsagesMailsRelation(
     ...
     */
    override fun where(condition: Condition?): JMoneyUsagesMailsRelation = JMoneyUsagesMailsRelation(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): JMoneyUsagesMailsRelation = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): JMoneyUsagesMailsRelation = where(DSL.notExists(select))
}
