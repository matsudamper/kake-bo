...
open class JCategoryMailFilterConditionOperatorTypeRecord() : UpdatableRecordImpl<JCategoryMailFilterConditionOperatorTypeRecord>(JCategoryMailFilterConditionOperatorType.CATEGORY_MAIL_FILTER_CONDITION_OPERATOR_TYPE), Record2<Int?, String?> {
