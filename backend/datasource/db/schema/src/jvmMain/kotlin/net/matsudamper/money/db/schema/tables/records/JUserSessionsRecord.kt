...
open class JUserSessionsRecord() : UpdatableRecordImpl<JUserSessionsRecord>(JUserSessions.USER_SESSIONS), Record5<String?, Int?, LocalDateTime?, LocalDateTime?, LocalDateTime?> {
    ...
    override fun valuesRow(): Row5<String?, Int?, LocalDateTime?, LocalDateTime?, LocalDateTime?> = super.valuesRow() as Row5<String?, Int?, LocalDateTime?, LocalDateTime?, LocalDateTime?>
    ...
    override fun values(value1: String?, value2: Int?, value3: LocalDateTime?, value4: LocalDateTime?, value5: LocalDateTime?): JUserSessionsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(sessionId: String? = null, userId: Int? = null, createdDate: LocalDateTime? = null, expireDatetime: LocalDateTime? = null, latestAccessedAt: LocalDateTime? = null): this() {
