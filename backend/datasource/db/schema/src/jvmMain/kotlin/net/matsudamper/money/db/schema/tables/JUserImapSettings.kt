...
open class JUserImapSettings(
     ...
     */
    override fun where(condition: Condition?): JUserImapSettings = JUserImapSettings(qualifiedName, if (aliased()) this else null, Internal.condition(this, condition))
     ...
     * Create an inline derived table from this table
     */
    override fun whereExists(select: TableLike<*>): JUserImapSettings = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: TableLike<*>): JUserImapSettings = where(DSL.notExists(select))
}
